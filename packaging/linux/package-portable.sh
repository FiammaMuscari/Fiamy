...
for plugin_subdir in platforms platformthemes platforminputcontexts xcbglintegrations \
  imageformats iconengines styles tls networkinformation multimedia; do
